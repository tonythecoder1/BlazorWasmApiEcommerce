        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Livres", "books" },
                    { 2, "Films", "movies" },
                    { 3, "Jeux vidéo", "video-games" },
                    { 4, "Périphériques", "peripheriques" }
                });
            ...
            migrationBuilder.InsertData(
                table: "Produtos_TBL",
                columns: new[] { "Id", "CategoriaId", "Description", "ImageUrl", "Title", "featured" },
                values: new object[,]
                {
                    { 1, 4, "Clavier avec interrupteurs bleus", "https://via.placeholder.com/150", "Clavier mécanique", true },
                    { 2, 4, "Souris avec DPI ajustable et LED RGB", "https://via.placeholder.com/150", "Souris gamer", false },
                    { 3, 1, "Un guide de bonnes pratiques de programmation par Robert C. Martin.", "https://via.placeholder.com/150", "Livre : Clean Code", false },
                    { 4, 1, "Traite de la modélisation logicielle orientée domaine.", "https://via.placeholder.com/150", "Livre : Domain-Driven Design", false },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "Clavier Standard", 149.99m, 99.99m },
                    { 1, 3, "Clavier Moyen", 159.99m, 109.99m },
                    { 2, 2, "Souris Petite", 89.99m, 59.99m },
                    { 2, 4, "Souris Grande", 99.99m, 69.99m }
                });
